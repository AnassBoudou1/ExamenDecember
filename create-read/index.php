            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Recepten
                            <a href="student-create.php" class="btn btn-primary float-end" style="background: #ffbe33;border-color: black;">Voeg een recept toe</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Uitleg</th>
                                    <th>Foto</th>
                                    <th>IngredientenPage</th>
                                    <th>Acties</th>
                                </tr>
                            </thead>
                            <tbody>

                            <?php echo ShowIndex($con); ?>
